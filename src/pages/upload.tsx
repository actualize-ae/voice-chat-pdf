...
export default function PdfUploader() {
  ...
  const [selectedDocument, setSelectedDocument] = useState<{id: string | null, url: string}>({
    id: null,
    url: ''
  })
          ...
          <div className="md:flex">
            <div className="md:w-1/2 p-6">
              ...
              {pdfFile && (
                <div className="mt-4">
                  ...
                  {uploadSuccess && (
                    <p className="mt-2 text-green-500 text-sm">File uploaded successfully!</p>
                  )}
                </div>
              )}
                ...
                <div className="mt-8">
                                ...
                                {documents.map((doc) => (
                                    ...
                                    className={`cursor-pointer p-2 rounded-md ${
                                        selectedDocument.id === doc.id ? 'bg-blue-100' : 'hover:bg-gray-100'
                                    }`}
                                    >
                                    {doc.id}
                                    </li>
            ...
            <div className="md:w-1/2 p-6 bg-gray-50">
              {(pdfFile || selectedDocument.id) ? (
                <div>
                  <Document file={pdfFile || selectedDocument.url} onLoadSuccess={onDocumentLoadSuccess}>
