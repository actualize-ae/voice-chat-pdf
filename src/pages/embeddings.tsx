...
export default function GenerateEmbeddingsComponent() {
  ...
  const [selectedDocuments, setSelectedDocuments] = useState<{id: string, url: string}[]>([])
    ...
    <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white shadow-xl rounded-lg overflow-hidden p-6">
          ...
          {useReranking && (
            <div className="mb-6">
              <Label htmlFor="rerankingResults" className="block text-sm font-medium text-gray-700 mb-1">
              ...
              <Input
                ...
                onChange={(e) => setRerankingResults(Math.min(parseInt(e.target.value) || 1, topK))}
                className="w-full"
              />
            </div>
          )}
